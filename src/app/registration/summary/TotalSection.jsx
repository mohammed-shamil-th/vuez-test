    ...
    return (
        <>{promocodeCodeApplied ? <div className="flex flex-wrap items-center justify-between mt-8">
            <div className="flex items-center space-x-2 mr-4 mb-3 md:mb-8">
                ...
                <span className="text-lg text-gray-400 line-through">EUR {formatToOneDecimal(totalAmount)}</span>
                <span className="text-lg font-bold text-gray-900">EUR {formatToOneDecimal(totalAmount - totalDiscount)}</span>
            ...
            <div className="flex justify-end mb-8">
                <div className="flex items-center gap-2 text-right">
                    <div className="text-2xl font-bold text-gray-900">Total: EUR {formatToOneDecimal(totalAmount)}</div>
